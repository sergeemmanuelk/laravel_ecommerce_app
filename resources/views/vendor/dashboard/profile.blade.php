...
@section('content')
    <section id="wsus__dashboard">
        <div class="container-fluid">
            @include('vendor.dashboard.partials.sidebar')
            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-3">
                                            <div class="wsus__dash_pro_img">
                                                <img src="{{ Auth::user()->image ? asset(Auth::user()->image) : asset('frontend/images/dashboard_user.jpg') }}" alt="img" class="img-fluid w-100">
